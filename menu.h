...
public:
	void init() {
		...
		debugaim.setup(XOR("draw aimbot shot records"), XOR("debugaim"));
...
public:
	void init() {
		...
		skyboxchange.setup(XOR("skyboxes"), XOR("skybox"), { XOR("Cloudy"),XOR("Night 1"),XOR("Night 2"),XOR("Night Flat") });
		RegisterElement(&skyboxchange);
	}
};
